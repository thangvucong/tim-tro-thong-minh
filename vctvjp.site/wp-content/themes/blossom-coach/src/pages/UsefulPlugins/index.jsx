...
const pluginList = [
    {
        pluginName: __("BlossomThemes Email Newsletter", "blossom-coach"),
        description: __("Easily add email subscription form to your website using shortcode and widget.", "blossom-coach"),
        slug: "blossomthemes-email-newsletter"
    },
    {
        pluginName: __("Regenerate Thumbnails", "blossom-coach"),
        description: __("Regenerate the thumbnails for one or more of your image uploads. Useful when changing their sizes or your theme.", "blossom-coach"),
        slug: "regenerate-thumbnails"
    },
    {
        pluginName: __("BlossomThemes Toolkit", "blossom-coach"),
        description: __("BlossomThemes Toolkit provides you necessary widgets for better and effective blogging.", "blossom-coach"),
        slug: "blossomthemes-toolkit"
    },
    {
        pluginName: __("Wheel of Life", "blossom-coach"),
        description: __("Powerful Tool for Coaches to Generate Leads and Grow Coaching Business.", "blossom-coach"),
        slug: "wheel-of-life"
    },
    {
        pluginName: __("Smash Balloon Social Photo Feed", "blossom-coach"),
        description: __("Formerly 'Instagram Feed'. Display clean, customizable, and responsive Instagram feeds from multiple accounts. Supports Instagram oEmbeds.", "blossom-coach"),
        slug: "instagram-feed"
    },
];
