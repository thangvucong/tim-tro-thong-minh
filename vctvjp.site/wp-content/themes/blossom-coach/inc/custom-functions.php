...
function blossom_coach_scripts(){
    ...
    wp_enqueue_script( 'v4-shims', get_template_directory_uri() . '/js' . $build . '/v4-shims' . $suffix . '.js', array( 'jquery' ), '6.5.1', true );
...
function blossom_coach_admin_notice() {
    ...
    $dismissnonce = wp_create_nonce( 'blossom-coach-update-notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=blossom-coach-dashboard' ) ); ?>" class="button button-primary" style="text-decoration: none;"><?php esc_html_e( 'Go to the getting started.', 'blossom-coach' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?blossom-coach-update-notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss','blossom-coach' ); ?></a></strong></p>
                </div>
            </div>
            <style>
...
function blossom_coach_ignore_admin_notice() {
    ...
    if ( ( isset( $_GET['blossom-coach-update-notice'] ) && $_GET['blossom-coach-update-notice'] = '1' ) && wp_verify_nonce( $_GET['_wpnonce'], 'blossom-coach-update-notice' ) ) {
